...
class SOUND_CHANGEParser(Parser):
    ...
    def _start_(self):  # noqa
        ...
        self.ast._define(["context", "source", "target"], [])
    ...
    def _feature_desc_(self):  # noqa
        ...
        def block1():
            self._feature_()
            self.add_last_node_to_name("feature_desc")

        self._positive_gather(block1, sep1)
        self._token("]")
        self.ast._define(["recons"], ["feature_desc"])
    ...
    def _back_ref_(self):  # noqa
        with self._choice():
            ...
            with self._option():
                ...
                self.name_last_node("back_ref")
            self._error("no available options")
        self.ast._define(["back_ref", "modifier", "recons"], [])
    ...
    def _sound_(self):  # noqa
        with self._choice():
            ...
            self._error("no available options")
        self.ast._define(["boundary", "ipa", "sound_class"], [])
    ...
    def _sound_class_(self):  # noqa
        with self._choice():
            ...
            with self._option():
                ...
                self.name_last_node("sound_class")
            self._error("no available options")
        self.ast._define(["modifier", "recons", "sound_class"], [])
