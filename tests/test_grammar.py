...
Tests for the grammar in the `alteruphono` package.
"""
...
class TestGrammar(unittest.TestCase):
    """
    Class for `alteruphono` tests related to grammar.
    """
...
class TestParser(unittest.TestCase):
    ...
    def test_sound_class(self):
        ...
        _ = self.parser.parse(
            "*MYCLASS[!voiced,bilabial]", rule_name="sound_class"
        )
        assert _["sound_class"] == "MYCLASS"
        assert _["recons"] == "*"
        assert _["modifier"]["feature_desc"][0]["value"] == "!"
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="sound_class"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_boundary_symbol(self):
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="boundary_symbol"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_position_symbol(self):
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="position_symbol"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_empty_symbol(self):
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="empty_symbol"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_expression(self):
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="expression"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_backref(self):
        ...
        with self.assertRaises(tatsu.exceptions.FailedParse):
            self.parser.parse(
                "[bilabial,voiced,consonant]", rule_name="back_ref"
            )
        with self.assertRaises(tatsu.exceptions.FailedParse):
    ...
    def test_feature_desc(self):
        ...
        _ = self.parser.parse(
            "[high=true,rounded=false]", rule_name="feature_desc"
        )
    ...
    def test_sequence(self):
        ...
        _ = self.parser.parse(
            "t|s a _ @1 [+high,-rounded]", rule_name="sequence"
        )
